...
public class EnchantingMechanics {
     ...
     */
    public List<CustomEnchantment> getAllValidEnchants(final ItemStack item,
                                                       final Permissible enchanter,
                                                       final int level,
                                                       final boolean table) {
        return FabledEnchants.getRegisteredEnchantments().stream()
    ...
    public double chance(final int level, final CustomEnchantment enchant, final int target) {
        final int min =
                (int) Math.ceil(enchant.getMinEnchantingLevel() + enchant.getEnchantLevelScaleFactor() * (target - 1));

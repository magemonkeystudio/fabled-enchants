...
public enum ItemSet {
    ...
    DURABILITY(SWORDS, TOOLS, BOWS, FISHING, ARMOR, CROSSBOW),
    DURABILITY_SECONDARY(UTILITY, HOES, GLIDERS, SHIELDS),
    DURABILITY_ALL(DURABILITY, DURABILITY_SECONDARY),

    VANILLA_ENCHANTABLES(SWORDS, TRIDENT, TOOLS, BOWS, FISHING, ARMOR, UTILITY, GLIDERS, CROSSBOW, MISCELLANEOUS),

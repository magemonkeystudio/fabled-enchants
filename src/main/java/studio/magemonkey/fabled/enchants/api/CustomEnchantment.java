...
public abstract class CustomEnchantment implements Comparable<CustomEnchantment> {
    ...
    private static final String SAVE_FOLDER = "enchants/custom/";

    private static final String
            COMBINE_COST_PER_LEVEL     = "combine-cost-per-level",
            DESCRIPTION                = "description",
            ENABLED                    = "enabled",
            ENCHANT_LEVEL_SCALE_FACTOR = "enchants-level-scale-factor",
            ENCHANT_LEVEL_BUFFER       = "enchants-level-buffer",
            GROUP                      = "group",
            MAX_LEVEL                  = "max-level",
    ...
    private static final List<String>
            BUFFER_COMMENT      =
            ImmutableList.of("", " How many enchantment levels beyond the max can still yield the enchantment"),
            COMBINE_COMMENT     = ImmutableList.of("", " Level cost per level of the enchantment"),
            LEVEL_SCALE_COMMENT = ImmutableList.of("",
                    " Higher numbers result in requiring higher enchanting levels",
                    " to get higher ranks"),
            GROUP_COMMENT       = ImmutableList.of("",
            ...
            MIN_COMMENT         = ImmutableList.of("",
                    " Minimum enchanting level to receive the enchantment.",
                    " Negatives make it easier to get higher ranks"),
            ITEM_COMMENT        =
                    ImmutableList.of("", " Items that can receive the enchantment from enchanting or anvils"),
            ANVIL_COMMENT       =
                    ImmutableList.of("", " Additional items that can only receive the enchantment through anvils"),
            STACK_COMMENT       = ImmutableList.of("",
                    " Whether or not the same enchantment stacks if on multiple items.",
                    " When false, the highest level is applied"),
            TABLE_COMMENT       =
                    ImmutableList.of("", " Whether or not this enchantment can be achieved from enchanting"),
            WEIGHT_COMMENT      =
                    ImmutableList.of("", " How common the enchantment is. Higher numbers are more common."),
    ...
    public void save(final FabledEnchants plugin) {
    ...
    public void load(final FabledEnchants plugin) {
        final CommentedConfig config = new CommentedConfig(plugin, getSaveFolder() + key);
